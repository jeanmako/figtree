...
export function PasswordInput({
  ...
  const handleChange = (
    e: BaseUIEvent<ChangeEvent<HTMLInputElement, HTMLInputElement>>
  ) => {
  ...
  return (
    <PasswordInputContext value={{ password: currentValue.toString() }}>
      <div className="w-full space-y-2">
        <InputGroup className="w-full overflow-hidden rounded-md">
          <InputGroupInput
            {...props}
            value={value}
          ...
          <InputGroupAddon align="inline-end">
            ...
            >
              <Icon className="size-4 text-quiet" />
...
export function PasswordInputStrengthChecker() {
  ...
  return (
    <div className="space-y-0.5">
      ...
      <div className="flex justify-end text-tiny leading-4 font-medium tracking-snug text-quiet">
