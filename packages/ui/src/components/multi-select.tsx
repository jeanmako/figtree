...
export function MultiSelectTrigger({
  ...
  return (
    ...
    >
      <span className="-mx-1.5 inline-flex w-[calc(100%+12px)] items-center justify-between">
        {children}
        ...
        .map((value) => {
          ...
          return (
            ...
            >
              {label}
              {clickToRemove && (
                <Icons.xFill className="transition-color size-3 duration-300 group-hover:text-destructive" />
              )}
            </Badge>
          )
        })}
