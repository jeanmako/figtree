...
const buttonVariants = cva(
  "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2.5 rounded-md bg-clip-padding text-sm font-semimedium tracking-snug whitespace-nowrap transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.75",
  {
    defaultVariants: {
      size: "default",
      variant: "default",
    ...
    variants: {
      size: {
        ...
        xs: "h-6 gap-1 rounded-md px-2 py-1 text-xs [&_svg:not([class*='size-'])]:size-3",
      },
      variant: {
        default:
